    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="order-2 md:order-1 container mx-auto px-4 pt-0 pb-8 md:py-8 md:w-4/5 text-[#697282]">
          <p className="mb-4">
            👋 Hi! Welcome to my photo blog! My name is Justin and I enjoy photography and technology. This is a project that I built to learn more about web development, design and AI. Photos taken by me, titles, descriptions and classification generated by AI.
          </p>
          <p className="mb-4">
        ...
        {/* Profile Section */}
        <div className="order-1 md:order-2 w-full md:w-1/5 flex flex-col items-center justify-start p-6 md:pt-16">
          <Image 
              src="/profile.jpg" 
              alt="Profile" 
              width={192}
              height={192}
              className="rounded-full w-48 md:w-3/4 h-auto mb-4"
              priority
          />
