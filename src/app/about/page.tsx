...
const AboutPage = () => {
  return (
    <div className="flex flex-col">
      ...
      {/* Main content area - rearranges between mobile and desktop */}
      <div className="flex flex-col md:flex-row">
        {/* Content Section */}
        <div className="order-2 md:order-1 container mx-auto px-4 pt-0 pb-8 md:py-8 md:w-4/5 text-[#697282]">
          <p className="mb-4">
        ...
        {/* Profile Section */}
        <div className="order-1 md:order-2 w-full md:w-1/5 flex flex-col items-center justify-start p-4 md:pt-16">
          <Image 
              src="/profile.jpg" 
              alt="Profile" 
              width={192}
